...
# Tools Used
- MS Excel – Test scenarios, test cases, RTM, bug report
- MS Word / PDF – Test summary report

# Scope:
The purpose of this project is to validate core e-commerce functionalities such as Login, Search, Cart, Checkout, and Payment.
